...
//		String datestring = request.getDatestring();
	...
	@GetMapping("/getTrain/specificDate/{date}/{train_id}")
	public Train getSpecific(@PathVariable("date") String date, @PathVariable("train_id") int train_id) throws ParseException {
